...
class TestMongo(object):
    ...
    def get_more(self):
        '''查询多条数据'''
        return self.db.blog.posts.find({'title': '新的标题'})
    ...
    def update(self):
        '''修改数据'''
        #修改一条数据
        # rest = self.db.blog.posts.update_one({'x': 21}, {'$inc': {'x': 10}})
        # return rest
        #修改多条数据
    ...
    def delete(self):
        '''删除数据'''
        #删除一条数据
        # return self.db.blog.posts.delete_one({'x': 41})
        #删除多条数据
...
def main():
    ...
    # rest = obj.get_one_from_oid('5b7a6ada1e708f52547c1983')
    # print(rest)
