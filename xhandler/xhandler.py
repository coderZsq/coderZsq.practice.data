...
def run():
    selectedIndexes = [1, 3, 6, 8, 9, 10, 11, 12, 14, 16, 17, 18, 19, 22, 23, 25, 26, 27, 28, 29, 30, 32, 
    ...
    names = pd.read_excel('./xlsxes/2019药品数据.xlsx', usecols=[3], skiprows=[1, 2, 3, 4, 5, 6]).values
    indexes = []
